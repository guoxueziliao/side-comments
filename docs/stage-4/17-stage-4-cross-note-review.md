...
Stage 4 decisions should be confirmed one topic at a time. Confirmed decisions should be written into this document or split into smaller `docs/stage-4/` documents when the topic grows.
