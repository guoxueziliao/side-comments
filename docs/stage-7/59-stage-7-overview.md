...
Stage 5 design documents under `docs/stage-5/` stay as the confirmed baseline. Stage 7 documents under `docs/stage-7/` supplement them by recording the deltas and the implementation pass. No Stage 5 document is rewritten or invalidated.
